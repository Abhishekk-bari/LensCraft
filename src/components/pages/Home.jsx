    ...
    <>
      ...
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']">
        ...
        <div className="w-full relative z-[2] h-screen text-white">
          <div className="text_container w-full px-4 md:px-[20%]">
            <div className="text w-full md:w-[50%]">
              ...
              <p className="text-lg font-normal w-full md:w-[80%] mt-10">
          ...
          <div className="w-full pb-24 absolute bottom-0 left-0">
            <h1 ref={headingref} className="pl-0 cursor-pointer text-[8rem] md:text-[14rem] font-normal tracking-tight leading-none">
              LensCraft Studio
            </h1>
          </div>
        </div>
      ...
      <div className="w-full relative mt-32 px-4 md:px-10 animate-fadeIn">
        {showCanvas && data[1].map((canvasdets, index) => <Canvas key={index} details={canvasdets} />)}
        <div className="relative z-[3] animate-fadeIn">
          <h1 className="text-4xl md:text-6xl tracking-tighter animate-pulse">Welcome to LensCraft Studio!</h1>
          <p className="text-lg md:text-2xl leading-[1.8] w-full md:w-[80%] mt-10 font-light animate-pulse">
            At LensCraft Studio, we believe every moment is worth capturing...
          </p>
        </div>
      </div>

      <div className="w-full relative mt-32 px-4 md:px-10">
        {showCanvas && data[2].map((canvasdets, index) => <Canvas key={index} details={canvasdets} />)}
        <Work />
      </div>

      <div className="contact w-full relative z-[] mt-32 px-4 md:px-10">
      ...
      <div className="pl-5 pt-28 font-['Helvetica_Now_Display'] relative z-[2] pb-0 ">
        ...
        <span className="text-5xl md:text-7xl">Let us create lasting memories together.</span>
      </div>
    </>
  );
};
